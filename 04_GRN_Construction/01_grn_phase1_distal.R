...
write.csv(homer_enriched, "homer_enriched_TFs.csv", row.names=FALSE)
...
write.csv(grn_edges, "GRN_edges.csv", row.names=FALSE)
...
write.csv(top_tfs, "top_TF_candidates.csv", row.names=FALSE)
