...
grn_edges_raw <- read.csv(file.path(OUTPUT_DIR, "01_Base_Motif_Network_Edges_distal.csv"), stringsAsFactors = FALSE)
...
cat("Distal active edges (Tier 3):  ", nrow(clean_grn), "\n")
...
write.csv(biological_grn, file.path(OUTPUT_DIR, "02_Filtered_Bio_Network_Edges_All_distal.csv"), row.names = FALSE)
write.csv(clean_grn, file.path(OUTPUT_DIR, "02_Filtered_Bio_Network_Edges_HighConf_distal.csv"), row.names = FALSE)
write.csv(master_regulators_grn, file.path(OUTPUT_DIR, "02_Network_Centrality_Scores_distal.csv"), row.names = FALSE)
...
write.csv(active_hubs, file.path(OUTPUT_DIR, "02_Top_Active_Hubs_distal.csv"), row.names = FALSE)
