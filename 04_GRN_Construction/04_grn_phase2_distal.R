...
grn_edges_raw <- read.csv("GRN_edges.csv", stringsAsFactors = FALSE)
...
write.csv(biological_grn, "GRN_Biological_Edges_All.csv", row.names = FALSE)
write.csv(clean_grn, "GRN_Biological_Edges_Tier1_Only.csv", row.names = FALSE)
write.csv(master_regulators_grn, "GRN_Master_Regulators.csv", row.names = FALSE)
...
write.csv(active_hubs, "top_TF_Biological_Hubs.csv", row.names = FALSE)
