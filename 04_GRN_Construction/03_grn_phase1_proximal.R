...
HOMER_CUSTOM   <- "homer_out_custom_proximal/knownResults.txt"
...
write.csv(homer_enriched, "homer_enriched_TFs_proximal.csv", row.names=FALSE)
...
write.csv(grn_edges, "GRN_edges_proximal.csv", row.names=FALSE)
...
write.csv(top_tfs, "top_TF_candidates_proximal.csv", row.names=FALSE)
